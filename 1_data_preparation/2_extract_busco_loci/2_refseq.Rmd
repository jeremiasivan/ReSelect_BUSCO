...
dir_busco_tree <- file.path(dir_busco, "trees")
dir_busco_treeshrink <- file.path(dir_busco, "trees_treeshrink")

lapply(list(dir_busco_lineage, dir_busco_ref, dir_busco_read, dir_busco_tree, dir_busco_treeshrink), function(x){
