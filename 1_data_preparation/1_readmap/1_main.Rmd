...
source(file.path(path.expand(params$codedir), "1_data_preparation", "1_readmap", "functions.R"), local=TRUE)
...
```{r child = file.path(path.expand(params$codedir), "1_data_preparation", "1_readmap", "2_run.Rmd")}
```
