...
```{r check-busco-read-common, include=is_busco_read, eval=is_busco_read}
# output data.table
...
for (prefix in ls_prefix) {
    ...
    shared_busco_gff <- file.path(dir_busco_read, prefix, paste0("run_", params$busco_lineage), "busco_sequences", "single_copy_busco_sequences", paste0(shared_busco, ".gff"))
