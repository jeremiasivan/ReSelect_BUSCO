...
source(file.path(path.expand(params$codedir), "data_preparation", "1_readmap", "functions.R"), local=TRUE)
...
# create log file
fn_log <- file.path(currentdir, paste0(params$prefix, "_readmap.log"))
...
```{r child = file.path(path.expand(params$codedir), "data_preparation", "1_readmap", "2_run.Rmd")}
```
