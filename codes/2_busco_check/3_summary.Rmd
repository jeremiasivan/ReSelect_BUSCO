---
title: "Summarise BUSCO Alignments and Trees"
---
...
```{r check-summary-individual, eval=is_check_summary_individual}
...
if (is.null(focal_sp) || focal_sp=="") {
    focal_sp <- sample(ls_refseq_available, 1)
}

f_write_log(fn_log=fn_log, msg=paste("Calculating pairwise distance against ", focal_sp))
