...
for (prefix in ls_prefix) {
    ...
    mean_coverage <- as.numeric(df_readmap_coverage$mean_coverage[df_readmap_coverage$read_sp==read & df_readmap_coverage$ref_sp==ref])
...
for (prefix in ls_prefix) {
    ...
    df_coverage <- rbind(df_coverage, data.table::data.table(read_id=df_reads$id[df_reads$species==readref[1]],
