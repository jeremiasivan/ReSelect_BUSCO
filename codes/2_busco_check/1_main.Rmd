...
if (params$type != "hybpiper") {
  knitr::knit_child(paste0(params$codedir,"/2_busco_check/3_summary.Rmd"))
  knitr::knit_child(paste0(params$codedir,"/2_busco_check/4_busco_tree.Rmd"))
} else {
  knitr::knit_child(paste0(params$codedir,"/2_busco_check/3a_summary_hybpiper.Rmd"))
}
```
