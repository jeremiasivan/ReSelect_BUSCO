...
```{r child = paste0(params$codedir,"/2_busco_check/3a_run_busco.Rmd")}
```

```{r child = paste0(params$codedir,"/2_busco_check/4a_summary.Rmd")}
```

```{r child = paste0(params$codedir,"/2_busco_check/3b_run_busco.Rmd"), include=FALSE, eval=FALSE}
```

```{r child = paste0(params$codedir,"/2_busco_check/4b_summary.Rmd"), include=FALSE, eval=FALSE}
```
