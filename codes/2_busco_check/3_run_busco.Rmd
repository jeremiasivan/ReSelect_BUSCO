...
# iterate over reference sequences
for (ref in ls_refseq) {
    species_names <- unlist(strsplit(f_extract_species_from_assembly(params$exe_efetch, ref), split=" "))
    species_name <- paste0(species_names[1],"_",species_names[2])
...
for (read in ls_shortreads) {
    species_names <- unlist(strsplit(f_extract_species_from_reads(params$exe_efetch, read), split=" "))
    species_name <- paste0(species_names[1],"_",species_names[2])
