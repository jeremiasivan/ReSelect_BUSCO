...
ls_shortreads <- df_shortreads$id[df_shortreads$is_check==TRUE]
...
df_ref_output <- data.table::as.data.table(do.call(rbind, ls_output$ref_out), fill=TRUE)
data.table::fwrite(df_ref_output, file=fn_ref_summary, sep="\t", quote=F, row.names=F)

df_read_output <- data.table::as.data.table(do.call(rbind, ls_output$read_out), fill=TRUE)
