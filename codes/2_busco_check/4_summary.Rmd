...
# generate plots
df_mntd_sum_melt <- reshape2::melt(df_mntd_sum_output, id.vars="busco")
df_mntd_sum_melt_cluster <- df_mntd_sum_melt[df_mntd_sum_melt$value == "C" | df_mntd_sum_melt$value == "",]
df_mntd_sum_melt_spread <- df_mntd_sum_melt[df_mntd_sum_melt$value == "S" | df_mntd_sum_melt$value == "",]

png(file=fn_mntd_cluster_png, width=1024, height=768)
ggplot(df_mntd_sum_melt_cluster, aes(x=variable, y=busco)) +
...
ggplot(df_mntd_sum_melt_spread, aes(x=variable, y=busco)) +
    geom_tile(aes(fill=value), color="white") +
