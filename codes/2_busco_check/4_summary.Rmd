...
# For distance matrix, make all possible pairs with NA instead -> more predictable
# p-value
...
```{check-summary-species-map, include=FALSE}
...
ls_output <- foreach (busco = shared_busco_filtered, .combine='c') %dopar% {
    ...
    for (read in ls_shortreads_available) {
        ...
        read_out[[read_species_name]] <- lm_statistics$pvalue
