...
df_busco_nrf <- foreach(busco = shared_busco, .combine='rbind') %dopar% {
    ...
    # calculate nRF
    read_tree_dist <- f_calculate_treedist(tre_read, tre_refs, 0)
    refs_tree_dist <- f_calculate_treedist(tre_refs, tre_read, 0)
    nrf <- round((read_tree_dist$dist+refs_tree_dist$dist) / nrf_denominator, 3)

    read_tree_dist_highbs <- f_calculate_treedist(tre_read, tre_refs, 95)
    refs_tree_dist_highbs <- f_calculate_treedist(tre_refs, tre_read, 95)
