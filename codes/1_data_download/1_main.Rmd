...
cat(paste0("Available reference sequences (", length(ls_refseq_available), "/", length(ls_refseq), ")"))
cat(paste("Reference sequences to be downloaded:", length(ls_refseq_download)))
```
...
cat(paste0("Available short reads (", length(ls_reads_available), "/", length(ls_shortreads), ")"))
cat(paste("Short reads to be downloaded:", length(ls_reads_download)))
```
